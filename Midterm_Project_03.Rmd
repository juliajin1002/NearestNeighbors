...
But following pairwise comparisons have p-value less than the standard 0.05:
NE - CO, NY - CO, TX - CO
...
The p-value is 0.181 > 0.05, so we fail to reject the null hypothesis, meaning we can say the mean of donation in different colleges are the same.
...
The p-value is 0.0925 > 0.05, so we fail to reject the null hypothesis, meaning we can say the mean of donations in each year are the same.
...
The p-value is 0.793 > 0.05, so we fail to reject the null hypothesis, meaning we can say the mean of donation received from different allocations are the same.
...
The p-value is 0.222 > 0.05, so we cannot reject our null hypothesis, meaning we can say the mean of donation received from different campus resources are the same.
...
The p-value is 0.850 > 0.05, so we cannot reject our null hypothesis, meaning we can say the mean of donation received from different endowments are the same.
