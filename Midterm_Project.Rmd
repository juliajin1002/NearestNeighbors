---
title: "Analyzing Donation to Universities in the US from 2010-2015"
...
Q: Is the donation in different states the same?

```{r boxplot_state, include = T}
loadPkg("ggplot2")
ggplot(donation2, aes(x=State, y=log10(Amount)))+geom_boxplot(outlier.size = 2)+labs(title = 'Donation vs. States', x='State', y='Amount (log10)')
```
...
Q: Is the donation that goes to different colleges the same?

```{r boxplot_college, include = T}
ggplot(donation2, aes(x=College, y=log10(Amount)))+geom_boxplot(outlier.size = 2)+labs(title = 'Donation vs. Colleges', x='College', y='Amount (log10)')
```
...
Q: Is the donation received in each year the same?

```{r boxplot_year, include = T}
ggplot(donation2, aes(x=Year, y=log10(Amount)))+geom_boxplot(outlier.size = 2)+labs(title = 'Donation vs. Years', x='Year', y='Amount (log10)')
```
...
Q: Is the donation with different allocation method the same?

```{r boxplot_allocation, include = T}
ggplot(donation2, aes(x=Gift_Allocation, y=log10(Amount)))+geom_boxplot(outlier.size = 2)+labs(title = 'Donation vs. Allocations', x='Allocation', y='Amount (log10)')
```
...
Q: Is the donation from different campus resources the same?

```{r boxplot_campus, include = T}
ggplot(campus_resource, aes(x=Allocation_Subcategory, y=log10(Amount)))+geom_boxplot(outlier.size = 2)+labs(title = 'Donation vs. Campus Resources', x='Resources', y='Amount (log10)')
```
...
Q: Is the donation of different endowments the same?

```{r boxplot_endowment, include = T}
ggplot(endowment, aes(x=Allocation_Subcategory, y=log10(Amount)))+geom_boxplot(outlier.size = 2)+labs(title = 'Donation vs. Endowments', x='Endowment', y='Amount (log10)')
```
...
Q: Is the donation from different scholarships the same?

```{r boxplot_scholarship, include = T}
ggplot(scholarship, aes(x=Allocation_Subcategory, y=log10(Amount)))+geom_boxplot(outlier.size = 2)+labs(title = 'Donation vs. Scholarships', x='Scholarship', y='Amount (log10)')
```
